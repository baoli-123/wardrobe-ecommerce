<template>
  <div>
    <el-dialog v-model="addDialogSon" @close="handleClose" title="上架服装" width="500">
      <el-form :model="formData"
        ...
        <el-form-item label="服装类别" prop="type">
          <el-select v-model="formData.type" placeholder="请选择服装类别" >
            <el-option
...
const submitForm = () => {
  ...
  ruleFormRef.value.validate((valid, fields) => {
    if (valid) {
      axios.post('/wardrobe_back/addClothes',data).then(res => {
        alert(res.data)
